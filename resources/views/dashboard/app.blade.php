...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('dashboard/vendor/multiple_image/dist/image-uploader.min.css') }}">
...
<!-- Scripts -->
    ...
    <script src="{{ asset('dashboard/vendor/multiple_image/dist/image-uploader.min.js') }}"></script>
